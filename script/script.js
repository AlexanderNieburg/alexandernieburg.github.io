...
function mc1() {
  ...
  document.getElementById("display1").innerHTML = "&nbsp &nbsp Your answer is:";
...
function mc2() {
  ...
  document.getElementById("display3").innerHTML = "&nbsp &nbsp Your answer is:";
...
function mc3() {
  ...
  document.getElementById("display5").innerHTML = "&nbsp &nbsp Your answer is:";
...
function mc4() {
  ...
  document.getElementById("display7").innerHTML = "&nbsp &nbsp Your answer is:";
...
function mc5() {
  ...
  document.getElementById("display9").innerHTML = "&nbsp &nbsp Your answer is:";
...
function mc6() {
  ...
  document.getElementById("display11").innerHTML = "&nbsp &nbsp Your answer is:";
...
function mc7() {
  ...
  document.getElementById("display13").innerHTML = "&nbsp &nbsp Your answer is:";
...
function mc8() {
  ...
  document.getElementById("display15").innerHTML = "&nbsp &nbsp Your answer is:";
